...
from launch.actions import (
    ...
    RegisterEventHandler, EmitEvent, TimerAction, IncludeLaunchDescription
)
...
def generate_launch_description():
    ...
    start_gazebo = IncludeLaunchDescription(
        ...
        launch_arguments={
            'world': 'src/map_struct/worlds/yahboomcar.world'  # 指定世界文件路径
        }.items()
    )
    ...
    microxrce_agent = ExecuteProcess(
        cmd=['MicroXRCEAgent', 'udp4', '-p', '8888',">","/dev/null","2>&1"],
        output='screen',
    ...
    ugv_model_path = '/home/suda/drone_ugv_ws/src/yahboomcar_self_nav/models/yahboomcar_X3/model.sdf'
